...
set the environment variable 'BULK_REMY_LOCKED' to $false; ie ($env:BULK_REMY_LOCKED = $false, either temporarily in the session, or permanently in the powershell [__$Profile__](https://docs.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_profiles?view=powershell-7.1)). The user should not unlock the command until they are comfortable with how to use this command properly
...
![picture](resources/images/bulk-rename.SWAP-CONTENT.dir-list.jpg)
...
![picture](resources/images/bulk-rename.MOVE-AND-DROP-FINAL.swapped.jpg)
