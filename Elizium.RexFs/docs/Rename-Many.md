...
Performs a bulk rename for all file system objects delivered through the pipeline, via regular expression replacement. For more information, please see [Bulk Renamer (Rename-Many)](https://github.com/EliziumNet/RexFs/blob/master/README.md)
